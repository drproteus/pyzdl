...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 1.0.5 on Sun Oct 20 13:38:02 2024
#
...
class MainWindow(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.sizer_7 = wx.GridBagSizer(0, 0)

        self.profile_name = wx.StaticText(
            self.window_1_pane_2, wx.ID_ANY, "Select a Profile"
        )
        ...
        self.sizer_7.Add(self.profile_name, (0, 0), (1, 1), wx.ALIGN_CENTER, 0)

        self.profile_html_view = wx.Window(self.window_1_pane_2, wx.ID_ANY)
        self.sizer_7.Add(self.profile_html_view, (1, 0), (1, 1), wx.EXPAND, 0)
        ...
        self.sizer_7.AddGrowableRow(1)
        self.sizer_7.AddGrowableCol(0)
        self.window_1_pane_2.SetSizer(self.sizer_7)
...
class AddProfileDialogWindow(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.add_profile_file_move_up_button = wx.Button(self, wx.ID_ANY, "↑")
        grid_sizer_2.Add(self.add_profile_file_move_up_button, (0, 0), (1, 1), 0, 0)

        self.add_profile_file_move_down_button = wx.Button(self, wx.ID_ANY, "↓")
