...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 1.0.5 on Tue Oct 15 17:02:23 2024
#
...
class MainWindow(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.profile_up_button = wx.Button(self.window_1_pane_1, wx.ID_ANY, u"↑")
        self.profile_up_button.SetMinSize((32, 20))
        sizer_6.Add(self.profile_up_button, (0, 2), (1, 1), 0, 0)

        self.profile_down_button = wx.Button(self.window_1_pane_1, wx.ID_ANY, u"↓")
        ...
        self.profile_saves_checkbox = wx.CheckBox(self.config_tab, wx.ID_ANY, "Profile Saves")
...
class AddProfileDialogWindow(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        add_profile_name_label = wx.StaticText(self, wx.ID_ANY, "Name", style=wx.ALIGN_CENTER_HORIZONTAL)
        ...
        self.add_profile_iwad_choice_list = wx.Choice(self, wx.ID_ANY, choices=["Doom", "Doom 2"])
        self.add_profile_iwad_choice_list.SetSelection(0)
        grid_sizer_1.Add(self.add_profile_iwad_choice_list, (1, 1), (1, 1), wx.EXPAND, 0)

        add_profile_source_port_label = wx.StaticText(self, wx.ID_ANY, "Port")
        grid_sizer_1.Add(add_profile_source_port_label, (2, 0), (1, 1), wx.ALIGN_CENTER, 0)

        self.add_profile_source_port_choice_list = wx.Choice(self, wx.ID_ANY, choices=["GZDoom"])
        self.add_profile_source_port_choice_list.SetSelection(0)
        grid_sizer_1.Add(self.add_profile_source_port_choice_list, (2, 1), (1, 1), wx.EXPAND, 0)
        ...
        self.add_profile_files_list_box = wx.ListBox(self, wx.ID_ANY, choices=["/Users/jake/test/foo.wad", "/Users/jake/test/foo2.wad"])
        ...
        self.add_profile_file_move_up_button = wx.Button(self, wx.ID_ANY, u"↑")
        grid_sizer_2.Add(self.add_profile_file_move_up_button, (0, 0), (1, 1), 0, 0)

        self.add_profile_file_move_down_button = wx.Button(self, wx.ID_ANY, u"↓")
        ...
        grid_sizer_3.Add(self.add_profile_cancel_button, (0, 0), (1, 1), wx.ALIGN_RIGHT | wx.EXPAND, 0)

        self.confirm_add_profile_button = wx.Button(self, wx.ID_ANY, "Confirm")
        grid_sizer_3.Add(self.confirm_add_profile_button, (0, 1), (1, 1), wx.ALIGN_RIGHT, 0)
...
class AddNamedResourceDialogWindow(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        grid_sizer_2.Add(self.add_named_resource_confirm_button, (0, 1), (1, 1), wx.ALIGN_RIGHT, 0)
